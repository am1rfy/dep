<template>
  ...
  >
    <section class="section">
      <h3 class="section__header">Паспортные данные</h3>
      ...
      <el-row :gutter="10">
        ...
        <el-col :span="12">
          <el-form-item
            prop="birth"
            label="Дата рождения"
            :rules="[requiredRule(), lengthRule(10)]"
          >
            <el-input
              v-model="form.birth"
              v-mask="'##.##.####'"
          ...
          <el-row :gutter="10">
            ...
            <el-col :span="12">
              <el-form-item
                ...
                :rules="[requiredRule(), lengthRule(7)]"
              >
                <el-input
    ...
    <section class="section">
      <h3 class="section__header">Контактные данные</h3>
